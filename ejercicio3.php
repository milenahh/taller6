...
<body>
    ...
    <div class="form-group col-md-6">
        ...
        <input type="tetx" name="apellido" class="form-control" id="apellido" placeholder="Ingrese su apellido" required>
    </div>
    <div class="form-row">
    <div class="form-group col-md-6">
        <label for="id">Cédula</label>
        <input type="number" name="id" class="form-control" id="id" placeholder="Ingrese su Identificación" required>
    </div>
    </div>
